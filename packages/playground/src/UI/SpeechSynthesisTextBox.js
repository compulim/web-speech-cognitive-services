    ...
    <div className="input-group-prepend">
      ...
      <div className="dropdown-menu">
        <button
          ...
          onClick={ () => setSpeechSynthesisText('Pooh is very social. After Christopher Robin, his closest friend is Piglet, and he most often chooses to spend his time with one or both of them.') }
          type="button"
        >Winnie the Pooh (English)</button>
        <button
          className="dropdown-item"
          onClick={ () => setSpeechSynthesisText('一天，悶悶不樂的愛麗絲跟姊姊同坐於河畔。忽見一隻古怪的白兔走過──牠穿戴打扮，手持懷錶，自言自語，行色匆匆。好奇的愛麗絲跟着牠跑，跳進兔子洞裏去。') }
          type="button"
...
export default connect(
  ({ speechSynthesisText }) => ({ speechSynthesisText }),
  { setSpeechSynthesisText }
